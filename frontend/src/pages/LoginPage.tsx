              ...
              <div className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className={`w-full flex justify-center items-center px-4 py-2 border border-transparent rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                  >
                    {isLoading ? (
                      <>
                        <svg
          ...
          <div className="bg-gray-50 px-8 py-4 border-t border-gray-200">
            <div className="flex items-center justify-center text-sm">
              ...
              <span className="text-gray-600">
                Secure login protected by bank-level security
              </span>
            </div>
          </div>
        </div>
        {/* Test Account Information */}
        <div className="max-w-md mx-auto mt-6 bg-blue-50 rounded-lg p-4 border border-blue-200">
